...
#this line will change for each dataset. 12 represents the number of samples in the filtered abundance table
abundance_desc = abundance_desc[,-c(12:ncol(abundance_desc))] 
