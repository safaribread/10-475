...
# keeping the uk study samples that are from vapers or cig smokers and are saliva sample type
metadata = metadata[metadata$Data_Origin == "UK_Stewart_et_al", ]
metadata = metadata[metadata$Sample_type == "Saliva", ]
metadata <- metadata[metadata$Smoking_status %in% c("EC", "C"), ]
...
abundance_desc = abundance_desc[,-c(20:ncol(abundance_desc))] 
